...
class CustomDelegate
  ...
  def shared_connection_pool()
      if ($connection_pool == nil)
         ...
         $connection_pool.setJdbcUrl("jdbc:mysql://lsstcam-db.cp.lsst.org:3306/ccsdbprod?serverTimezone=UTC&autoReconnect=true")
  ...
  def filesystemsource_pathname(options = {})
      ...
      identifier = context['identifier']
      imageRoot = "/home/ccs/cantaloupe/cantaloupe-5.0/images"

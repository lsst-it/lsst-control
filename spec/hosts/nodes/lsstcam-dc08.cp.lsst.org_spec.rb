...
describe 'lsstcam-dc08.cp.lsst.org', :sitepp do
  on_supported_os.each do |os, os_facts|
    ...
    context "on #{os}" do
      ...
      context 'with ens1f0np0' do
        ...
        it { expect(nm_keyfile['ipv4']['address1']).to eq('139.229.175.72/26,139.229.175.126') }
      ...
      context 'with ens1f1np1' do
        ...
        it_behaves_like 'nm enabled interface'
        it_behaves_like 'nm ethernet interface'
        it { expect(nm_keyfile['ipv4']['address1']).to eq('139.229.173.139/27,139.229.173.129') }

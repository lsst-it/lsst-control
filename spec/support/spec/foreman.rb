...
shared_examples 'generic foreman' do
...

  {
    ...
    'enable-official-puppet7-repo': false,
    'enable-official-puppet8-repo': true,
    fips_enabled: false,
  ...
  it do
    is_expected.to contain_restic__repository('foreman').with(
      ...
      backup_pre_cmd: "/bin/bash -c 'rm -rf /tmp/foreman-backups && /bin/foreman-maintain backup online -y /tmp/foreman-backups'",

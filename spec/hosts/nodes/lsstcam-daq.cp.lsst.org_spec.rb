...
describe 'lsstcam-daq.cp.lsst.org', :sitepp do
  on_supported_os.each do |os, os_facts|
    ...
    context "on #{os}" do
      ...
      it { is_expected.to contain_host('lsstcam-sm').with_ip('192.168.101.2') }
      ...
      context 'with enp34s0f1' do
        let(:interface) { 'enp34s0f1' }
